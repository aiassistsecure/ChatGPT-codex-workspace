...
Run the catalog validator and project checks before review. Record unavailable toolchains honestly. Check in generated application lockfiles once resolved by the real package manager; never hand-author a Cargo.lock. Initial scaffolds may lack a lockfile, but reproducible release work must resolve and commit one.
